 ...
 * 
 *		gra_clr.js
 *		v0.0.0.00001			Sep 20, 2014		-
 *		v0.0.0.00002			Oct 03, 2014		-
 *
 */
...
var gra_clr = function(parent, ops) {
	...
	this.func            = typeof ops.func=='function'?ops.func:function(){return false;};
	this.hue             = function(h) {
		var r,g,b,
			m = Math.floor(h*6),
			f = h*6-m,
	...
	this.satel.style.width       = '116px'; //'165px';
	this.satel.style.height      = '116px'; //'165px';
	this.satel.style.marginRight = '10px';
	...
	this.hueel.style.width       = '10px'; //'18px';
	this.hueel.style.height      = '116px'; //'165px';
