	...
	_g.cl = (_g.color = {
		...
		picker	: function(p, o){
			...
			this.satel	= document.createElement('div').set({
				...
				className	: 'gra_clr-sat',
				innerHTML	: '<svg width="100%" height="100%" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="gd" x1="0%" y1="100%" x2="0%" y2="0%"><stop offset="0%" stop-color="#000000" stop-opacity="1"></stop><stop offset="100%" stop-color="#000000" stop-opacity="0"></stop></linearGradient><linearGradient id="gs" x1="0%" y1="100%" x2="100%" y2="100%"><stop offset="0%" stop-color="#ffffff" stop-opacity="1"></stop><stop offset="100%" stop-color="#ffffff" stop-opacity="0"></stop></linearGradient></defs><rect x="0" y="0" width="100%" height="100%" fill="url(#gs)"></rect><rect x="0" y="0" width="100%" height="100%" fill="url(#gd)"></rect></svg>',
				style		: {
					position	: 'relative',
					width		: '116px',
					height		: '116px',
			...
			this.satsl	= document.createElement('div').set({
				...
				className	: 'gra_clr-sat-selector',
				style		: {
					position	: 'absolute',
					left		: 'calc(100% - 6px)',
					top			: '-6px',
			...
			_g.cl.hueel	= document.createElement('div').set({
				...
				className	: 'gra_clr-hue',
				innerHTML	: '<svg width="100%" height="100%" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="gh" x1="0%" y1="100%" x2="0%" y2="0%"><stop offset="00.000%" stop-color="#ff0000" stop-opacity="1"></stop><stop offset="16.666%" stop-color="#ff00ff" stop-opacity="1"></stop><stop offset="33.333%" stop-color="#0000ff" stop-opacity="1"></stop><stop offset="50.000%" stop-color="#00ffff" stop-opacity="1"></stop><stop offset="66.666%" stop-color="#00ff00" stop-opacity="1"></stop><stop offset="83.333%" stop-color="#ffff00" stop-opacity="1"></stop><stop offset="100.00%" stop-color="#ff0000" stop-opacity="1"></stop></linearGradient></defs><rect x="0" y="0" width="100%" height="100%" fill="url(#gh)"></rect></svg>',
				style		: {
					position	: 'relative',
					width		: '10px',
					height		: '116px',
			...
			_g.cl.huesl	= document.createElement('div').set({
				...
				className	: 'gra_clr-hue-selector',
				style		: {
					position	: 'absolute',
					left		: '100%',
					top			: '-4px',
