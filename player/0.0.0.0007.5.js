...
/*  NOTES ON VERSION 0007.5:
 *		Added dragging time bar
...
var gra_aud = function(element, audio, options) {
	...
	this.init = function() {			//Initialize
		...
		this.volm.onclick				= function(){this.sound.muted=!this.sound.muted}.bind(this);
		this.volm.innerHTML 			= '<svg viewBox="0 0 16 16"><polygon fill="#FFFFFF" points="0,0 16,8 0,16 "/></svg>';
		...
		this.volmbox.style.webkitTransition	= 'width 0.35';
