 ...
 *		v0.4.2.0018				Jan 06, 2014		Fixed copy link loaction for blank links
 */
...
gra.context = {
	...
	open : function (e, o) {
		...
		if(hr != '')
			swfobject.embedSWF("http://api.phene.co/gra_cm_flash/copy.swf", "context-link-copy", "200", "21", "0.0.1", false, {cBoard:hr}, {wMode:'transparent'}, {}, function(e){
				e.ref.style.opacity = 0;
				e.ref.style.position = 'absolute';
				e.ref.style.marginTop = '-2px';
				e.ref.style.left = '2px';
