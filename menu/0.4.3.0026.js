 ...
 *		v0.4.2.0020				Feb 21, 2015		Added video element source copy
 *		v0.4.2.0021				Feb 21, 2015		Added video element pause/play buttons
 *		v0.4.2.0022				Feb 21, 2015		Added video element mute/unmute buttons
 *		v0.4.2.0023				Feb 21, 2015		Fixed menu not closing after pressing copy buttons
 *		v0.4.2.0024				Feb 21, 2015		Added video element source download button
 *		v0.4.2.0025				Feb 21, 2015		Added link download button
 *		v0.4.2.0026				Feb 21, 2015		Fixed scroll to position function (__stp__)
 */
...
_g.cx = (_g.context = {
	...
	open : function (e, o) {
		...
		if (pa = el.parentAnchor()) {
			...
			c.innerHTML += '<a href="' + hr + '" onclick="_g.cx.close();" download target="_blank"><div class="context-option">Save Link As...</div></a>';
			c.innerHTML += '<div style="margin:2px 4px;height:1px;background:#ddd;"></div>'
		}
		...
		if(e.target.tagName === 'VIDEO'){
			...
			c.innerHTML += '<a href="' + e.target.src + '" onclick="_g.cx.close();" download target="_blank"><div class="context-option">Save Video As...</div></a>';
			c.innerHTML += '<div style="margin:2px 4px;height:1px;background:#ddd;"></div>';
		}
