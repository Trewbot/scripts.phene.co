...
function gra_cm (e,options) {
	...
	if(pa = el.parentAnchor()) {
		var hr = pa.href;
		if(~hr.indexOf(gra_url)) cmo.innerHTML += '<a href="'+hr+'" permalink onclick="gra_cm_hide();"><div class="context-option">Open Link as Permalink</div></a>';
	...
	cmo.innerHTML += '<a href="'+gra_url+'/changes" onclick="gra_cm_hide();"><div class="context-disabled"><i>Graphene '+gra_v+'</i></div></a>';
